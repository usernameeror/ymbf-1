...
def moch_yayan():
    ...
    print(" • You Name : %s%s%s"%(K,nama,N));time.sleep(0.03)
    print(' ___________________________________________________'%(O,P));time.sleep(0.03)
    print('  • Code by : Aangxd & Yayanxd'%(O,P));time.sleep(0.03)
    print('  • Team    : XNX-CODE TEAM'%(O,P));time.sleep(0.03)
    print('  • Github  : Github.com/AngCyber'%(O,P));time.sleep(0.03)
    print(' ___________________________________________________'%(O,P));time.sleep(0.03)
